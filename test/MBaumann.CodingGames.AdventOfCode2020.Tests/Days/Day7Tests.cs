...
dark violet bags contain no other bags.";
        ...
        public void Part1()
        {
            Check.That(Day7.CountBagColorsThatContainAtLeastOneShinyGoldBag(INPUT)).IsEqualTo(4);
        }
        ...
        public void Part2a()
        {
            Check.That(Day7.CountBagsInsideShinyGoldBag(INPUT)).IsEqualTo(32);
        }
        ...
        public void Part2b()
        {
            Check.That(Day7.CountBagsInsideShinyGoldBag(INPUT2)).IsEqualTo(126);
        }
    }
}